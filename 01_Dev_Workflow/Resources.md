...
Class slides can be viewed in PDF format in the ```/slides``` directory, or interactively using the browser: [view slides online](http://slid.es/brianbugh/01-working-like-a-developer?token=rn4NTKCQ9hLz1JcX9Azo3yo1HJ8r "view slides online").
